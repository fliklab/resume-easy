    ...
    if (paths.length === 1) {
      ...
      if (section === "certifications") {
        ...
        if (
          ...
          // 타입 단언 대신 구체적인 타입 처리
          if (section === "personal") {
            (sectionData as Personal)[field as keyof Personal] = value;
          } else if (section === "skills") {
            (sectionData as Skills)[field as keyof Skills] = value;
          } else if (section === "education") {
            (sectionData as Education)[field as keyof Education] = value;
          }
